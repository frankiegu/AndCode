$(document).ready(function () {
    ...
    $(document).on("click", ".btn-edit-project", function () {
        ...
        localStorage.setItem("edit-record-id", colDbId.text());
    ...
    $("#btn-edit-save").click(function () {
        var versionId = localStorage.getItem("edit-record-id");
...
function getProjectList(userId, index) {
    ...
    var versionId = localStorage.getItem("versionVersionId");
    $.get("/ZzApiDoc/v1/versionRecord/getAllVersionRecordWeb?userId=" + userId + "&versionId=" + versionId + "&page=" + index,
        function (data, status) {
            if (status === 'success') {
                //填充表格
                var c = "";
...
function doDelete() {
    ...
    $.post("/ZzApiDoc/v1/versionRecord/deleteVersionWeb", {
            userId: userId,
 ...
 * 编辑版本
 */
function editResParam(recordId) {
